...
The project uses the UCI Polish Companies Bankruptcy dataset for historical model training and SEC/XBRL financial data for the public-company borrower layer.
